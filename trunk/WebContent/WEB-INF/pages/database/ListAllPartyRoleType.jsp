                  ...
                  <ktm:else>
                    <ktm:iterate name="bean" property="partyRoleTypeCollection" id="partyRoleType">
                      <div>
                        ...
                        <div class="gridBox" style="width: 400px;">
                          ${ktm:getText(partyRoleType.name)}
                        </div>
                        <div class="gridBox" style="width: 243px;">
                          <input type="button" value="edit" onclick="goTo('CRUDPartyRoleType?method=edit&uniqueId=${partyRoleType.uniqueId}')">
                          <input type="button" value="delete" onclick="doDelete('Do you want to delete ?','CRUDPartyRoleType?method=del&uniqueId=${partyRoleType.uniqueId}')">
                        </div>
                      </div>
                    </ktm:iterate>
                    </ktm:else>
