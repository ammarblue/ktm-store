                ...
                <div class="ym-wbox">
                  <form class="ym-form ym-columner" action="CRUDPerson" method="post">
                    ...
                    <div class="ym-fbox-text">
                      <label for="citizenId">${ktm:getText("nav.database.employee.citizenId")}<sup class="ym-required">*</sup></label>
                    ...
                    <div class="ym-fbox-text">
                      <label for="firstname">${ktm:getText("nav.database.employee.firstname")}<sup class="ym-required">*</sup></label>
                      <input type="text" name="firstname" id="firstname" size="20"
                        required="required" value="${bean.firstname}"
                      />
                    </div>
                    <div class="ym-fbox-text">
                      <label for="lastname">${ktm:getText("nav.database.employee.lastname")}<sup class="ym-required">*</sup></label>
                      <input type="text" name="lastname" id="lastname" size="20"
                        required="required" value="${bean.lastname}"
                      />
                    </div>
                    <div class="ym-fbox-text">
                      <label for="birthDay">${ktm:getText("nav.database.employee.birthday")}</label>
                    ...
                    <div class="ym-fbox-button">
                      <input type="submit" class="ym-button" value='${ktm:getText("page.btn.save")} ${ktm:getText("nav.database.employee")}' id="submit"
                        name="submit"
                      />
