...
public interface ProductCatalogDao extends Dao {
    ...
    /*
     * Adds a ProductType to the ProductCatalog by assigning it to an 
    ...
    /*
     * Return a set of ProductTypes that have the given catalogIdentifier. 
     * Where a business system only has one ProductType per CatalogEntry, 
     * this set contains a single ProductType
     */
