...
/*
 * The PartyRelationshipContraint specifics the names of PartyRoles
 * that may adopt the client and supplier sides of a PartyRelationship of a
 * specific PartyRelationshipType.
 */
@Entity
